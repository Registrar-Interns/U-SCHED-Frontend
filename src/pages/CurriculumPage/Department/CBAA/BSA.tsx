...
import BSACurriculumTables from "../../../../components/curriculum/BSACurriculumTables";
import BSAElectivesTable from "../../../../components/curriculum/BSAElectivesTable";
...
const BSA: React.FC = () => {
  ...
  return (
    <>
      <PageMeta
        title="BSA Curriculum | iUCSchedProMax+"
        description="BSA Curriculum page for iUCSchedProMax+"
      />
      ...
      <PageBreadcrumb
        ...
        segments={[
          ...
          { name: "Curriculum", path: "/department/cbaa/bsa" },
          { name: "Department", path: "/department/cbaa/bsa" },
          { name: "CBAA", path: "/department/cbaa/bsa" },
      ...
      <div className="space-y-6">
        ...
        {year !== "ELECTIVES" ? (
          <BSACurriculumTables courses={courses} />
        ) : (
          <BSAElectivesTable courses={courses} />
        )}
      </div>
    </>
  );
