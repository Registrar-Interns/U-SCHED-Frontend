...
import BEEDCurriculumTables from "../../../../components/curriculum/BEEDCurriculumTables";
import BEEDElectivesTable from "../../../../components/curriculum/BEEDElectivesTable";
...
const BEED: React.FC = () => {
  ...
  return (
    <>
      <PageMeta
        title="BEED Curriculum | iUCSchedProMax+"
        description="BEED Curriculum page for iUCSchedProMax+"
      />
      ...
      <PageBreadcrumb
        ...
        segments={[
          ...
          { name: "Curriculum", path: "/department/coed/beed" },
          { name: "Department", path: "/department/coed/beed" },
          { name: "COE", path: "/department/coed/beed" },
      ...
      <div className="space-y-6">
        ...
        {year !== "ELECTIVES" ? (
          <BEEDCurriculumTables courses={courses} />
        ) : (
          <BEEDElectivesTable courses={courses} />
        )}
      </div>
    </>
  );
