...
import BSEDMCurriculumTables from "../../../../components/curriculum/BSEDMCurriculumTables";
import BSEDMElectivesTable from "../../../../components/curriculum/BSEDMElectivesTable";

const BSEDM: React.FC = () => {
  ...
  return (
    <>
      <PageMeta
        title="BSEDM Curriculum | iUCSchedProMax+"
        description="BSEDM Curriculum page for iUCSchedProMax+"
      />
      ...
      <PageBreadcrumb
        ...
        segments={[
          ...
          { name: "Curriculum", path: "/department/coed/bsedm" },
          { name: "Department", path: "/department/coed/bsedm" },
          { name: "COE", path: "/department/coed/bsedm" },
      ...
      <div className="space-y-6">
        ...
        {year !== "ELECTIVES" ? (
          <BSEDMCurriculumTables courses={courses} />
        ) : (
          <BSEDMElectivesTable courses={courses} />
        )}
      </div>
    </>
  );
