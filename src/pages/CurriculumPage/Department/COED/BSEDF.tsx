...
import BSEDFCurriculumTables from "../../../../components/curriculum/BSEDFCurriculumTables";
import BSEDFElectivesTable from "../../../../components/curriculum/BSEDFElectivesTable";

const BSEDF: React.FC = () => {
  ...
  return (
    <>
      <PageMeta
        title="BSEDF Curriculum | iUCSchedProMax+"
        description="BSEDF Curriculum page for iUCSchedProMax+"
      />
      ...
      <PageBreadcrumb
        ...
        segments={[
          ...
          { name: "Curriculum", path: "/department/coed/bsedf" },
          { name: "Department", path: "/department/coed/bsedf" },
          { name: "COE", path: "/department/coed/bsedf" },
      ...
      <div className="space-y-6">
        ...
        {year !== "ELECTIVES" ? (
          <BSEDFCurriculumTables courses={courses} />
        ) : (
          <BSEDFElectivesTable courses={courses} />
        )}
      </div>
    </>
  );
