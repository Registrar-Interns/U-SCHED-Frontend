...
import BSEDSCurriculumTables from "../../../../components/curriculum/BSEDSCurriculumTables";
import BSEDSElectivesTable from "../../../../components/curriculum/BSEDSElectivesTable";

const BSEDS: React.FC = () => {
  ...
  return (
    <>
      <PageMeta
        title="BSEDS Curriculum | iUCSchedProMax+"
        description="BSEDS Curriculum page for iUCSchedProMax+"
      />
      ...
      <PageBreadcrumb
        ...
        segments={[
          ...
          { name: "Curriculum", path: "/department/coed/bseds" },
          { name: "Department", path: "/department/coed/bseds" },
          { name: "COE", path: "/department/coed/bseds" },
      ...
      <div className="space-y-6">
        ...
        {year !== "ELECTIVES" ? (
          <BSEDSCurriculumTables courses={courses} />
        ) : (
          <BSEDSElectivesTable courses={courses} />
        )}
      </div>
    </>
  );
