...
import BSPSYCurriculumTables from "../../../../components/curriculum/BSPSYCurriculumTables";
import BSPSYElectivesTable from "../../../../components/curriculum/BSPSYElectivesTable";

const BSPSY: React.FC = () => {
  ...
  return (
    <>
      <PageMeta
        title="BSPSY Curriculum | iUCSchedProMax+"
        description="BSPSY Curriculum page for iUCSchedProMax+"
      />
      ...
      <PageBreadcrumb
        ...
        segments={[
          ...
          { name: "Curriculum", path: "/department/cas/bspsy" },
          { name: "Department", path: "/department/cas/bspsy" },
          { name: "CAS", path: "/department/cas/bspsy" },
      ...
      <div className="space-y-6">
        ...
        {year !== "ELECTIVES" ? (
          <BSPSYCurriculumTables courses={courses} />
        ) : (
          <BSPSYElectivesTable courses={courses} />
        )}
      </div>
    </>
  );
