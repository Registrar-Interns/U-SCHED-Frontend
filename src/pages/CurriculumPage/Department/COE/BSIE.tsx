    ...
    <>
      ...
      <PageBreadcrumb
        ...
        segments={[
          ...
          { name: "Curriculum", path: "/department/coe/bsie" },
          { name: "Department", path: "/department/coe/bsie" },
          { name: "COE", path: "/department/coe/bsie" },
