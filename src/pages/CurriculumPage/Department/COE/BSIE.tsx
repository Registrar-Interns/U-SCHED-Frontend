...
import BSIECurriculumTables from "../../../../components/curriculum/BSIECurriculumTables";
import BSIEElectivesTable from "../../../../components/curriculum/BSIEElectivesTable";
...
const BSIE: React.FC = () => {
  ...
  return (
    <>
      <PageMeta
        title="BSIE Curriculum | iUCSchedProMax+"
        description="BSIE Curriculum page for iUCSchedProMax+"
      />
      ...
      <PageBreadcrumb
        ...
        segments={[
          ...
          { name: "Curriculum", path: "/department/ccs/bsie" },
          { name: "Department", path: "/department/ccs/bsie" },
          { name: "COE", path: "/department/ccs/bsie" },
          { name: "BSIE", path: "/department/ccs/bsie" },
        ]}
      />
      ...
      <div className="space-y-6">
        ...
        {year !== "ELECTIVES" ? (
          <BSIECurriculumTables courses={courses} />
        ) : (
          <BSIEElectivesTable courses={courses} />
        )}
      </div>
    </>
  );
