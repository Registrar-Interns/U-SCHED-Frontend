...
import BSECECurriculumTables from "../../../../components/curriculum/BSECECurriculumTables";
import BSECEElectivesTable from "../../../../components/curriculum/BSECEElectivesTable";

const BSECE: React.FC = () => {
  ...
  return (
    <>
      <PageMeta
        title="BSECE Curriculum | iUCSchedProMax+"
        description="BSECE Curriculum page for iUCSchedProMax+"
      />
      ...
      <PageBreadcrumb
        ...
        segments={[
          ...
          { name: "Curriculum", path: "/department/coe/bsece" },
          { name: "Department", path: "/department/coe/bsece" },
          { name: "COE", path: "/department/coe/bsece" },
      ...
      <div className="space-y-6">
        ...
        {year !== "ELECTIVES" ? (
          <BSECECurriculumTables courses={courses} />
        ) : (
          <BSECEElectivesTable courses={courses} />
        )}
      </div>
    </>
  );
