...
interface BSPSYCurriculumTablesProps {
  courses: Course[];
}
...
const BSPSYCurriculumTables: React.FC<BSPSYCurriculumTablesProps> = ({ courses }) => {
                ...
                <TableHeader>
                  ...
                  <TableRow>
                    <TableCell
                      colSpan={6}
                      isHeader
                      className="px-5 py-3 font-medium text-white bg-red-800 dark:bg-red-900 border border-gray-300"
                    >
                      {semester}
                    </TableCell>
                  </TableRow>
...
export default BSPSYCurriculumTables;