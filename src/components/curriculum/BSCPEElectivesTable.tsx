...
interface BSCPEElectivesTableProps {
  courses: Course[];
}

const BSCPEElectivesTable: React.FC<BSCPEElectivesTableProps> = ({ courses }) => {
                  ...
                  <TableHeader>
                    ...
                    <TableRow>
                      <TableCell
                        colSpan={6}
                        isHeader
                        className="px-5 py-3 font-medium text-white bg-red-600 dark:bg-red-700 border border-gray-300"
                      >
                        {electiveName}
                      </TableCell>
                    </TableRow>
...
export default BSCPEElectivesTable;